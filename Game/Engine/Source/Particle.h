...
struct Particle{
	...
	Particle(Vector2 position, Vector2 velocity, float lifespan, uint8_t r, uint8_t g, uint8_t b, uint8_t a) : position{ position }, velocity{ velocity }, lifespan{ lifespan }, r{ r }, g{ g }, b{ b }, a{ a } {}
